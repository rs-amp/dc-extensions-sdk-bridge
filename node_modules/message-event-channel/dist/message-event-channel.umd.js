(function (global, factory) {
	...
	***************************************************************************** */
	...
	})(exports.MC_EVENTS || (exports.MC_EVENTS = {}));
	/**
	...
	var Connection = /** @class */ (function () {
	    ...
	    Connection.prototype.emit = function (event, payload) {
	        this.message({
	            type: exports.MESSAGE_TYPE.EMIT,
	            event: event,
	            payload: payload
	        });
	        return this;
	    ...
	    Connection.prototype.request = function (event, payload, options) {
	        ...
	        return new Promise(function (resolve, reject) {
	            ...
	            _this.message({
	                type: exports.MESSAGE_TYPE.REQUEST,
	                event: event,
	                id: uuid,
	                payload: payload
	            });
	    ...
	    Connection.prototype.setConnectionTimeout = function () {
	        ...
	        if (this.options.connectionTimeout !== false) {
	            this.connectionTimeout = window.setTimeout(function () {
	                ...
	                _this.handleMessage({
	                    type: exports.MESSAGE_TYPE.EMIT,
	                    event: exports.MC_EVENTS.CONNECTION_TIMEOUT,
	    ...
	    Connection.prototype.finishInit = function () {
	        ...
	        this.emit(exports.MC_EVENTS.CONNECTED);
	    ...
	    Connection.prototype.handleMessage = function (message) {
	        ...
	        switch (message.type) {
	            case exports.MESSAGE_TYPE.EMIT:
	                ...
	                break;
	            case exports.MESSAGE_TYPE.REQUEST:
	                if (!this.emitters[message.event] || !Array.isArray(this.emitters[message.event])) {
	                    return;
	                }
	                this.emitters[message.event].forEach(function (cb) {
	                    return cb(message.payload, function (payload) {
	                        _this.message({
	                            id: message.id,
	                            type: exports.MESSAGE_TYPE.RESOLVE,
	                            event: message.event,
	                            payload: payload
	                        });
	                    }, function (payload) {
	                        _this.message({
	                            id: message.id,
	                            type: exports.MESSAGE_TYPE.REJECT,
	                            event: message.event,
	                            payload: payload
	                        });
	                    });
	                ...
	                break;
	            case exports.MESSAGE_TYPE.RESOLVE:
	                ...
	                break;
	            case exports.MESSAGE_TYPE.REJECT:
	                if (!this.promises[message.id]) {
	                    return;
	                }
	    ...
	    Connection.prototype.message = function (message) {
	        var force = false;
	        if (message.event === exports.MC_EVENTS.HANDSHAKE ||
	            message.event === exports.MC_EVENTS.CONNECTED ||
	            message.event === exports.MC_EVENTS.DISCONNECTED) {
	            force = true;
	        }
	...
	var ServerConnection = /** @class */ (function (_super) {
	    ...
	    function ServerConnection(frame, options) {
	        ...
	        _this.on(exports.MC_EVENTS.DISCONNECTED, function () { return _this.close(); });
	        return _this;
	    }
	    ...
	    ServerConnection.prototype.listenForHandshake = function () {
	        var _this = this;
	        this.on(exports.MC_EVENTS.HANDSHAKE, function (payload, resolve) {
	            resolve(payload);
	            _this.finishInit();
	        });
	    };
	...
	var ClientConnection = /** @class */ (function (_super) {
	    ...
	    ClientConnection.prototype.listenForHandshake = function () {
	        ...
	        this.request(exports.MC_EVENTS.HANDSHAKE, null, { timeout: false })
	            .then(function () {
	    ...
	    ClientConnection.prototype.addBeforeUnloadEvent = function () {
	        ...
	        this.options.window.addEventListener('beforeunload', function (event) {
	            _this.emit(exports.MC_EVENTS.DISCONNECTED);
	            _this.close();
	        });
	    };
...
//# sourceMappingURL=message-event-channel.umd.js.map
