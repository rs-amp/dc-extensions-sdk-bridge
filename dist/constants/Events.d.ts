...
export declare enum CONTENT_ITEM {
    GET = "content-item-get"
}
export declare enum MEDIA_LINK {
    IMAGE_GET = "media-image-get",
    VIDEO_GET = "media-video-get"
}
export declare enum CONTENT_LINK {
    CONTENT_GET = "content-link-get"
}
export declare enum CONTENT_REFERENCE {
...
export declare enum CONTENT_EDITOR_FORM {
